...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-product_purchase_homologation',
    download_url='https://github.com:nantic/trytond-product_purchase_homologation.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-product_purchase_homologation.git'
    },
    classifiers=[
